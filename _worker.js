...
const generateRemark = (index, port) => {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `🌹 Rose - Domain_${index + 1} : ${port}`;
            break;
        case 2:
        case 3:
            remark = `🌹 Rose - IPv4_${index - 1} : ${port}`;
            break;
        case 4:
        case 5:
            remark = `🌹 Rose - IPv6_${index - 3} : ${port}`;
            break;
        default:
            remark = `🌹 Rose - Clean IP_${index - 5} : ${port}`;
            break;
    }
...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = '🌹 Rose Frag - WorkerLess ⭐'
...
const getFragmentConfigs = async (env, hostName, client) => {
    ...
    bestPing.remarks = '🌹 Rose Frag - Best Ping 💥';
    ...
    bestFragment.remarks = '🌹 Rose Frag - Best Fragment 😎';
...
const getWarpConfigs = async (env, client) => {
    ...
    xrayWarpBestPing.remarks = '🌹 Rose - Warp Best Ping 🚀'
    ...
    xrayWoWOutbounds.forEach((outbound, index) => {
        if (outbound.tag.includes('warp-out')) {
            ...
            xrayWoWConfig.remarks = `🌹 Rose - WoW ${index/2 + 1} 🌍`;
